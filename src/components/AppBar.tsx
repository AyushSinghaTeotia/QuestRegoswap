import { ChainId, Currency } from 'quest-regoswap-sdk'
                                    ...
                                    <div className="flex items-center justify-between sm:justify-end space-x-2 w-full">                          
                                        ...
                                        {chainId &&
                                            ...
                                            library.provider.isMetaMask && (
                                                <>
                                                    <QuestionHelper
                                                        text={i18n._(t`Add xREGO to your Metamask wallet`)}
                                                    >
                                                        {/* <div
                                                                ...
                                                                if (
                                                                    ...
                                                                    library.provider
                                                                        ...
                                                                        .then(success => {
                                                                            if (success) {
                                                                                console.log(
                                                                                    'Successfully added xREGO to MetaMask'
                                                                                )
                                                                            } else {
                                                                                throw new Error('Something went wrong.')
                                                                            }
                                                                ...
                                                                if (
                                                                    ...
                                                                    library.provider
                                                                        ...
                                                                        .then(success => {
                                                                            if (success) {
                                                                                console.log(
                                                                                    'Successfully added REGO to MetaMask'
                                                                                )
                                                                            } else {
                                                                                throw new Error('Something went wrong.')
                                                                            }
