import { ChainId, JSBI, Percent, Token, WETH } from 'quest-regoswap-sdk'
...
export const REGO: ChainTokenMap = {
    [ChainId.MAINNET]: new Token(
        ChainId.MAINNET,
...
export const xREGO: ChainTokenMap = {
    [ChainId.MAINNET]: new Token(
        ChainId.MAINNET,
...
export const MATIC: { [key: string]: Token } = {
    ...
    // REGO: new Token(ChainId.MATIC, '0x52B8E9296B3c605eA7e9ecF1d201254bc9D55F54',18, 'SAMK', 'RegoToken'),
