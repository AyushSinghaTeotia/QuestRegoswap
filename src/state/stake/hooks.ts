import { ChainId, CurrencyAmount, JSBI, Pair, Token, TokenAmount, WETH } from 'quest-regoswap-sdk'
import useCurrentBlockTimestamp from 'hooks/useCurrentBlockTimestamp'
import { useMemo } from 'react'
import { DAI, SUSHI, USDC, USDT, WBTC, REGO} from '../../constants'
...
export function useStakingInfo(pairToFilterBy?: Pair | null): StakingInfo[] {
    ...
    const uni = chainId ? REGO[chainId] : undefined 
